...
const { createTaskSchema, updateTaskSchema, submitTaskSchema, rejectTaskSchema } = require('../utils/validators');
...
router.post('/:id/submit', validate(submitTaskSchema), taskController.submitTask);
